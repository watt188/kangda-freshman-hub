...
export default function Home() {
  return <>
    ...
    <main id="top">
      <section className="hero"><div className="eyebrow">FRESHMAN STARTER KIT · V1.2</div><h1>康大新生<br/>资料库</h1><p className="lede">不是网盘资料堆，而是一张可以真正开始使用的大学学习地图。</p><div className="hero-actions"><a className="button primary" href="#resources">开始浏览</a><a className="button" href="#words">医学英语 100 词</a></div><p className="micro">2026级同学个人整理 · 免费分享 · 持续更新 · 非康复大学官方资料</p></section>
      <section className="metrics"><div><strong>02</strong><span>首发资料</span></div><div><strong>100</strong><span>医学构词单位</span></div><div><strong>07</strong><span>本科专业地图</span></div><div><strong>V1.2</strong><span>当前版本</span></div></section>
      ...
      <section id="planner" className="section planner-section"><div className="section-kicker">02 / COURSE PLANNER · V1.2</div><h2>康大选课助手</h2><p className="section-intro">只看2026级真实通识选修课，自动叠加临床医学1班课表，先排冲突，再生成3学分A / B / C方案与实际抢课顺序。</p><CoursePlanner/></section>
